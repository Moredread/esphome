...
CONF_BASELINE_DATA = 'baseline_data'
...
CONFIG_SCHEMA = cv.Schema({
    ...
    cv.Required(CONF_BASELINE_DATA): sensor.sensor_schema(UNIT_EMPTY, ICON_RADIATOR, 0),
...
def to_code(config):
    ...
    sens = yield sensor.new_sensor(config[CONF_BASELINE_DATA])
    cg.add(var.set_baseline_data(sens))
